...
* **Static Equilibrium**: End node support reactions matched perfectly at **75.00 kN** ($R_A = R_B$).
* **Internal Work**: Peak positive bending moment verified at **187.50 kNm** at the beam mid-span.
* **Matrix Stiffness**: True-scale elastic deflection curves matched completely at a maximum displacement of **97.656 m**.
